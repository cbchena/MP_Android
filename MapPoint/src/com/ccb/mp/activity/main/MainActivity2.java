 ...
 * 主界面 2015/6/25 15:01
 */
public class MainActivity2 extends Activity implements BaiduMap.OnMapClickListener {

    private static Logger logger = LoggerFactory
            .getLogger(MainActivity2.class); // 日志对象
        ...
        _locationClient.registerLocationListener(new BDLocationListener() {
            ...
            public void onReceiveLocation(BDLocation location) {
                ...
                if (isSuccess) {
                    ...
                    MapStatusUpdate mapStatusUpdate_zoom = MapStatusUpdateFactory.zoomTo(17);
